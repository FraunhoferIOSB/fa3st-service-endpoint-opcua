 ...
 */
package de.fraunhofer.iosb.ilt.fa3st.service.endpoint.opcua.creator;
...
import de.fraunhofer.iosb.ilt.fa3st.service.endpoint.opcua.AasServiceNodeManager;
import de.fraunhofer.iosb.ilt.fa3st.service.endpoint.opcua.ValueConverter;
...
import de.fraunhofer.iosb.ilt.fa3st.service.endpoint.opcua.helper.UaHelper;
...
public class EntityCreator extends SubmodelElementCreator {
    ...
    /**
     * Sets the globalAssetId.
     *
     * @param entityNode The desired UA node
     * @param value The value of the globalAssetId to set
     * @param nodeManager THe corresponding Node Manager
     * @throws StatusException If the operation fails
     * @throws ValueFormatException If the value is not in valid format
     */
