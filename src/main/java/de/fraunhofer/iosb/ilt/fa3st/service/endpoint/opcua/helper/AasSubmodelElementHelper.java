...
import de.fraunhofer.iosb.ilt.fa3st.service.endpoint.opcua.creator.AasReferenceCreator;
import de.fraunhofer.iosb.ilt.fa3st.service.endpoint.opcua.creator.EntityCreator;
...
public class AasSubmodelElementHelper {
    ...
    /**
     * Set value and type for the desired Range.
     *
     * @param valueType The desired value type
     * @param minValue The desired min value
     * @param maxValue The desired max value
     * @param range The UA range type
     * @param minData The UA min data element
     * @param maxData The UA max data element
     * @throws StatusException If an error occurs
     */
